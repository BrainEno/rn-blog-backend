...
__decorate([
    (0, type_graphql_1.Field)(),
    (0, typeorm_1.Index)(),
    (0, class_validator_1.IsEmail)(undefined, { message: '请填写有效的邮箱地址' }),
    (0, class_validator_1.Length)(1, 255, { message: '邮箱地址不能为空' }),
    (0, typeorm_1.Column)('text', { unique: true }),
    __metadata("design:type", String)
], User.prototype, "email", void 0);
__decorate([
    (0, typeorm_1.Column)('text'),
    (0, class_validator_1.MinLength)(6, { message: '密码不能小于6个字符' }),
    __metadata("design:type", String)
], User.prototype, "password", void 0);
__decorate([
    (0, typeorm_1.Column)('varchar', { nullable: false, default: Roles_1.default.PASSAGER }),
    (0, type_graphql_1.Field)(() => [Roles_1.default]),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, typeorm_1.OneToMany)(() => Blog_1.default, (blog) => blog.author),
    __metadata("design:type", Array)
], User.prototype, "blogs", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => [Vote_1.default]),
    (0, typeorm_1.OneToMany)(() => Vote_1.default, (vote) => vote.user),
    __metadata("design:type", Array)
], User.prototype, "votes", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => [Like_1.default]),
...
__decorate([
    ...
    (0, typeorm_1.OneToMany)(() => Reply_1.default, (reply) => reply.user),
    __metadata("design:type", Array)
