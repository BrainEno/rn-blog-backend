...
exports.upload = multer_1.default({
    storage: multer_1.default.diskStorage({
        ...
        filename: (_, file, callback) => {
            ...
            callback(null, name + posix_1.default.extname(file.originalname));
        },
    }),
...
const uploadPicture = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let oldImageUrn = "";
        if (type === "image") {
            let blog = yield Blog_1.default.findOneOrFail({ identifier: req.body.identifier });
            if (!blog)
            ...
            let cat = yield Category_1.default.findOneOrFail({ name: req.body.catName });
            if (!cat)
